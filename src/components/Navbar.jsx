        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-80 max-w-[85vw] bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800/80 p-6 shadow-2xl z-[70] md:hidden flex flex-col"
            >
              {/* Drawer Header */}
                        ...
                        <Link
                          ...
                          className={`block rounded-lg px-4 py-2.5 text-sm transition-all duration-200 border-l-2 ${
                            pathname === link.href
                              ...
                              : 'text-slate-600 dark:text-slate-400 border-transparent hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-slate-200 hover:border-slate-300 dark:hover:border-slate-700'
                          }`}
                        >
                          {link.name}
                        </Link>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-800/80 space-y-3">
                {HAS_CLERK ? (
                  ...
                  <button
                    title="Auth not configured"
                    disabled
                    className="w-full rounded-xl bg-slate-100 dark:bg-slate-800 px-4 py-2.5 text-sm font-semibold text-slate-500 border border-slate-200 dark:border-slate-700 transition-all duration-300 opacity-50 cursor-not-allowed"
                  >
                    Sign In
                  </button>
                )}
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setOpen(false)}
                  className="flex items-center justify-center gap-2 w-full rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-slate-200 transition-all duration-300 shadow-md active:scale-95"
                >
                  <img
                    src={githubIcon}
                    alt="Github Repository Link"
