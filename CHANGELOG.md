...
- expand question bank and upgrade Challenge Mode with smart adaptive AI, timer, analytics, and visualizer practice links
- mjor issue fix
- update concepts overview with search filter, category tabs, and comprehensive descriptions
- update search bar to pinpoint every page, algorithm, data structure, and deep link
- enhance deep-linking and dynamic SEO metadata across all visualizer routes
- add Segment Tree visualizer to Abstract Data Types
- add Hash Table (HashMap) visualizer to Abstract Data Types
- add TypeScript typings for AlgoScope SDK
- restore greedy algorithms and implement job sequencing visualizer

### Fixed

- move AlgorithmNotes below main content
- enable search modal from mobile hamburger drawer using portal and proper navigation callbacks
- render mobile hamburger drawer via React Portal to prevent CSS fixed positioning trapping
- make homepage difficulty filter bar mobile scrollable and responsive
- resolve routing, lazy-loading, notesKey drawer, breadcrumbs, and theme support inconsistencies
- clear stale result message when switching query type
- address coderabbitai review comments in SegmentTreeIV
- list & format

### Changed

- streamline desktop navigation layout and clean up GitHub action button
...
- 📁 **src/**
  ...
  - 📁 **components/**
    ...
    - 📁 **dataStructures/**
      ...
      - ➕ SegmentTreeIV.jsx
    - 📁 **dynamicProgramming/**
      - ✏️ DPOptimizationJourney.jsx
      - ✏️ DPVisualizer.jsx
    - 📁 **greedyAlgo/**
      - ➕ GreedyAlgorithmCard.jsx
      - ➕ GreedyBlock.jsx
      - ➕ HuffmanVisualizer.jsx
      - ➕ JobSequencingVisualizer.jsx
    ...
    - 📁 **slidingwindow/**
      - ✏️ SlidingWindowVisualizer.jsx
    - 📁 **stringAlgo/**
      - ✏️ VisualizerPage.jsx
    - 📁 **twoPointer/**
      - ✏️ TwoPointerVisualizer.jsx
    - ✏️ AppLayout.jsx
    - ✏️ Breadcrumbs.jsx
    - ✏️ Home.jsx
    - ✏️ Navbar.jsx
